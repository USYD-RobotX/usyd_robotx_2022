...
OCCUPANCY_GRID_VALUE_THRESHOLD = rospy.get_param('~threshold', 5)

DIST_THRESH = rospy.get_param('~distance_threshold',1); #Distance between clusters before it is condidered seperate


CLOSE_OBJECT_DISTANCE_THRESH = 0.5  # Distance Threshold to conider detected object the same object
