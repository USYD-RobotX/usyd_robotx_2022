...
class NavDataBridge():
    ...
    def __init__(self):
        ...
        self.imu_sub = rospy.Subscriber("xsens_imu", Imu, self.imu_cb)
        self.imu_pub = rospy.Publisher("xsens_imu2", Imu, queue_size=1)
    ...
    def imu_cb(self, data):
        ...
        data.linear_acceleration.x = y
        data.linear_acceleration.y = -x
