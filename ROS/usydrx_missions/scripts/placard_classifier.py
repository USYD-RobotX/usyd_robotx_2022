...
class PlacardClassifier(Classifier):
    ...
    def __init__(self):
        ...
        self.template_labels = [
            ["blue_circle",     "green_circle",   "red_circle", "yellow_circle"],
            ["blue_cross",       "green_cross",    "red_cross", "yellow_cross"],
            ["blue_triangle", "green_triangle", "red_triangle", "yellow_triangle"],
            ["blue_rectangle", "green_rectangle", "red_rectangle", "yellow_rectangle"]]

        self.template_colours = [ # RGB colours
            [(0, 0, 120), (0, 120, 0), (120, 0, 0), (120, 120, 0)], # blue, green, red , yello
            [(0, 0, 120), (0, 120, 0), (120, 0, 0), (120, 120, 0)],
            [(0, 0, 120), (0, 120, 0), (120, 0, 0), (120, 120, 0)],
            [(0, 0, 120), (0, 120, 0), (120, 0, 0), (120, 120, 0)]]

        pre = rospkg.RosPack().get_path('usyd_vrx_solutions')+"/template_images/template_placard_"
    ...
    def getCentre(self, img, cnt):
        ...
        try:
            ...
            cY = 20 # cnt[0, 0, 0] # Select first point in contour
            cX = 20 # cnt[0, 0, 1]
        return cX, cY
    ...
    def classifyPlacard(self, img):
        ...
        contours = list(self.getSymbolContours(mask))
        # return "", None , None
