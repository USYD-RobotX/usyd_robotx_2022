...
class wp_goto_state_t(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(wp_goto_state_t._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != wp_goto_state_t._get_packed_fingerprint():
            raise ValueError("Decode error")
        return wp_goto_state_t._decode_one(buf)
    decode = staticmethod(decode)

    def _decode_one(buf):
        self = wp_goto_state_t()
    ...
    def _get_hash_recursive(parents):
        if wp_goto_state_t in parents: return 0
    ...
    def _get_packed_fingerprint():
        if wp_goto_state_t._packed_fingerprint is None:
            wp_goto_state_t._packed_fingerprint = struct.pack(">Q", wp_goto_state_t._get_hash_recursive([]))
        return wp_goto_state_t._packed_fingerprint
