...
class collection_config_t(object):
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.n):
            assert self.properties[i0]._get_packed_fingerprint() == vs.property_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.properties = []
        for i0 in range(self.n):
            self.properties.append(vs.property_t._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x98c0e311d21721a8+ vs.property_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
