...
class cov_collection_t(object):
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.ncovs):
            assert self.covs[i0]._get_packed_fingerprint() == vs.cov_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.covs = []
        for i0 in range(self.ncovs):
            self.covs.append(vs.cov_t._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xf7f172f9b65deb3+ vs.cov_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
