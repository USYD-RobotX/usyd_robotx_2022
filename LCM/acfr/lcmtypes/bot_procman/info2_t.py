...
import bot_procman.deputy_cmd2_t
...
class info2_t(object):
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.ncmds):
            assert self.cmds[i0]._get_packed_fingerprint() == bot_procman.deputy_cmd2_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.cmds = []
        for i0 in range(self.ncmds):
            self.cmds.append(bot_procman.deputy_cmd2_t._decode_one(buf))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x594fec8cdb8bc81c+ bot_procman.deputy_cmd2_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
