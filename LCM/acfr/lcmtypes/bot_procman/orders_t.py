...
import bot_procman.sheriff_cmd_t
...
class orders_t(object):
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.ncmds):
            assert self.cmds[i0]._get_packed_fingerprint() == bot_procman.sheriff_cmd_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.cmds = []
        for i0 in range(self.ncmds):
            self.cmds.append(bot_procman.sheriff_cmd_t._decode_one(buf))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x88ae05f979d423b1+ bot_procman.sheriff_cmd_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
