...
class gpsd3_v1_t(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(gpsd3_v1_t._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != gpsd3_v1_t._get_packed_fingerprint():
            raise ValueError("Decode error")
        return gpsd3_v1_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        if gpsd3_v1_t in parents: return 0
        newparents = parents + [gpsd3_v1_t]
    ...
    def _get_packed_fingerprint():
        if gpsd3_v1_t._packed_fingerprint is None:
            gpsd3_v1_t._packed_fingerprint = struct.pack(">Q", gpsd3_v1_t._get_hash_recursive([]))
        return gpsd3_v1_t._packed_fingerprint
